...
# 1. Subset the Data for Hippocampus and Cortex
# Assuming 'metadata' contains the metadata information
gene <- DESeqDataSetFromMatrix(
  countData = gene_matrix, # the counts values for all samples in our dataset
  colData = metadata, # annotation data for the samples in the counts data frame
  design = ~refinebio_specimen_part # Here we are not specifying a model
