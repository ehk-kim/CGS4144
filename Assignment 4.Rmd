...
colnames(annot_df) <- c("Brain_part", "Kmean_cluster", "Hier_cluster", "PAM_cluster", "___")
...
sample_annot <- HeatmapAnnotation(df = annot_df,
                                  col = list(Brain_part = c("cortex" = "#E1BE6A", "hippocampus" = "#40B0A6"),
                                             Support_vector_machine = c("1" = "#1A85FF", "2" = "#D41159"),
                                             Logistic_regression = c("1" = "#005AB5", "2" = "#DC3220"),
                                             K_nearest_neighbors = c("1" = "#5D3A9B", "2" = "#E66100")),
                                             naive_bayes = c("1" = "#f22e9d", "2" = "#93f22e"))
                                  annotation_label = c("Brain part", "Support vector machine", "Logistic regression", "K nearest neighbors", "Naïve Bayes")
